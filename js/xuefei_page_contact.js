...
$(function() {
  ...
  //  },
    ...
    submitSuccess:function($form, event){
      ...
      var Name = name;
      var resumeRequest=document.getElementById("msg_resumeRequest").checked;
    ...
    emailjs.send("xuefei", "template_Msg", {"Name":name,"email":email,"message":message,"resume":resumeRequest}).then(function(response) {
      ...
      $('#msg_success > .alert-success').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
          .append("</button>");
      $('#msg_success > .alert-success')
          .append("<strong><i class='fa fa-smile-o fa-2x' style='color: #3c763d;'></i> Thank you, "+Name+", your message has been sent. </strong>");
      $('#msg_success > .alert-success')
          .append('</div>');
      ...
      $('#msg_success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
          .append("</button>");
      $('#msg_success > .alert-danger').append("<strong><i class='fa fa-frown-o fa-2x' style='color:#a94442;'></i>  Sorry " + Name + ", it seems that my mail server is not responding. </strong>");
